...
namespace checkpoint_web.Pages.Bodega
{
    ...
    public class RecepcionModel : PageModel
    {
        ...
        public RecepcionModel(IProductoService productoService, IUbicacionService ubicacionService, IProveedorService proveedorService, CheckpointDbContext context, IAuditService auditService)
        {
            (_productoService, _ubicacionService, _proveedorService, _context, _auditService) = (productoService, ubicacionService, proveedorService, context, auditService);
        }
        ...
        public SelectList Proveedores { get; set; } = new SelectList(new List<Proveedor>(), "Id", "Nombre");
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var lote = new Lote
            {
                ...
                ProveedorId = ProveedorId,  // AGREGADO: Incluir proveedor
